...
{{% side-sm-large   %}} 
{{% sidebar date="" class="col-md-3" %}} what we are about {{% /sidebar %}}
...
>}}
{{% side-sm-large class=""   %}} 
{{% sidebar date="" class="col-md-3" %}} How we help get more revenue in a managed way {{% /sidebar %}}
{{% large-col class="col-md-8 col-md-push-1"  %}} 
...
{{% side-sm-large class=""   %}} 
{{% sidebar date="" class="col-md-3" %}} Who we are {{% /sidebar %}}
{{% large-col class="col-md-8 col-md-push-1"  %}} 
